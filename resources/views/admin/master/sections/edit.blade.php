 ...
 <div class="tab-pane" id="tab_4">
        <div class="portlet box purple">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
            <form action="{{route('sections.update' , $sections->id)}}" method="POST" class="form-horizontal form-row-seperated">
                @csrf
                @method('PATCH')
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                            <input type="text" placeholder="الإسم" name="title" value="{{$sections->title}}" class="form-control" />
                            </div>
                        </div>
