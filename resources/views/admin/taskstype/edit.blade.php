 ...
 <div class="tab-pane" id="tab_4">
        <div class="portlet box red">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
            <form action="{{route('taskstype.update' , $taskstype->id)}}" method="POST" class="form-horizontal form-row-seperated">
                @csrf
                @method('PATCH')
                    <div class="form-body">
                         <div class="form-group">
                            ...
                            <div class="col-md-9">
                            <input type="text" placeholder="الحالة" value="{{$taskstype->type}}" name="type" class="form-control" />
                            </div>
                        </div>    
                         {{-- <div class="form-group">
                            <label class="control-label col-md-3">الحالة</label>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{route('taskstype.index')}}" type="button" class="btn default">إلغاء</a>
                            </div>
                        </div>
                    </div>
                </form>
