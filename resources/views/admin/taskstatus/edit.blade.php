 ...
 <div class="tab-pane" id="tab_4">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i> تعديل حالة  </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
            <form action="{{route('taskstatus.update' , $taskstatus->id)}}" method="POST" class="form-horizontal form-row-seperated">
                @csrf
                @method('PATCH')
                    <div class="form-body">
                         <div class="form-group">
                            ...
                            <div class="col-md-9">
                            <input type="text" placeholder="الحالة" value="{{$taskstatus->status}}" name="status" class="form-control" />
                            </div>
                        </div>    
                         {{-- <div class="form-group">
                            <label class="control-label col-md-3">الحالة</label>
